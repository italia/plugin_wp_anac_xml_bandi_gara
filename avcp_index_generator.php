...
$avcp_denominazione_ente = get_option('avcp_denominazione_ente');
	...
	$XML_FILE .= '<?xml version="1.0" encoding="UTF-8"?>
		...
		<urlFile>' . site_url() . '/italia-anac-xml-bandi-gara/indice.xml</urlFile>
		<licenza>IODL</licenza>
		</metadata>
		<indice>
		<dataset id="ID_1">
		<linkDataset>' . site_url() . '/italia-anac-xml-bandi-gara/2012.xml</linkDataset>
		<dataUltimoAggiornamento>' . $XML_data_aggiornamento . '</dataUltimoAggiornamento>
		</dataset>
		<dataset id="ID_2">
		<linkDataset>' . site_url() . '/italia-anac-xml-bandi-gara/2013.xml</linkDataset>
		<dataUltimoAggiornamento>' . $XML_data_aggiornamento . '</dataUltimoAggiornamento>
		</dataset>
		</indice>
		</indici>';
	...
	$XML_PATH = ABSPATH . 'italia-anac-xml-bandi-gara/indice.xml';
