                        ...
                        <form method="post" name="options" target="_self">
                            ...
                            <?php
                                foreach ( $terms as $term ) {
                                    ...
                                    if ($xml->schemaValidate(ABSPATH  . '/wp-content/plugins/italia-anac-xml-bandi-gara/includes/XSD/'.$xsd_dir.'/datasetAppaltiL190.xsd')) {
            ...
            <div class="meta-box-sortables">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        $system_ok = true;
                        if(is_dir($dir)) {
                            echo 'Presenza cartella /italia-anac-xml-bandi-gara<font style="color:green;font-weight:bold;"> ==> OK</font>';
                        } else {
                            echo 'Presenza cartella /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> NON TROVATA</font>';
                            $system_ok = false;
                        }
                        echo '<br/>';
                        if (is_writeable($dir)) {
                            echo 'Permessi scrittura cartella /italia-anac-xml-bandi-gara<font style="color:green;font-weight:bold;"> ==> OK</font>';
                        } else {
                            echo 'Permessi scrittura cartella /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> NON CORRISPONDENTI</font>';
                            $system_ok = false;
                        }
                        echo '<br/>';
                    
                        if (file_exists($file)) {
                            echo 'Presenza index.php /italia-anac-xml-bandi-gara<font style="color:green;font-weight:bold;"> ==> OK</font>';
                        } else {
                            echo 'Presenza index.php /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> NON TROVATO</font>';
                            $system_ok = false;
                        }
                        echo '<br/>';
                    
                        $urlcheck = get_site_url() . '/italia-anac-xml-bandi-gara/index.php';
                        ...
                        if(is_callable('curl_init')){
                            ...
                            if($httpcode==200) {
                                echo 'Test Accesso pubblico /italia-anac-xml-bandi-gara<font style="color:green;font-weight:bold;"> ==> OK [200]</font>';
                            } else if($httpcode==500) {
                                echo 'Test Accesso pubblico /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> ERRORE 500 ISE</font>';
                                $headers = get_headers($urlcheck);
                                echo ' - ' . $headers[0];
                                $system_ok = false;
                            } else {
                                echo 'Test Accesso pubblico /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> ERRORE ' . $httpcode . '</font>';
                                $headers = get_headers($urlcheck);
                                echo ' - ' . $headers[0];
                                $system_ok = false;
                            }
                        } else {
                            echo 'Test Accesso pubblico /italia-anac-xml-bandi-gara<font style="color:red;font-weight:bold;"> ==> CURL_INIT MANCANTE</font>';
                            $system_ok = false;
                        }
